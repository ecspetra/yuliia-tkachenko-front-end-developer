...
export const FRONT_END_DEVELOPER_PROJECTS_LIST = [
	{
		...
		images: [
			'/assets/images/gradedreaders-image-1.webp',
			'/assets/images/gradedreaders-image-2.webp',
			'/assets/images/gradedreaders-image-3.webp',
			'/assets/images/gradedreaders-image-4.webp',
			'/assets/images/gradedreaders-image-5.webp',
			'/assets/images/gradedreaders-image-6.webp',
			'/assets/images/gradedreaders-image-7.webp',
			'/assets/images/gradedreaders-image-8.webp',
			'/assets/images/gradedreaders-image-9.webp',
			'/assets/images/gradedreaders-image-10.webp',
		],
	...
	},
	{
		...
		images: [
			'/assets/images/trackslyn-image-1.webp',
