export const EXPERIENCE_LIST = [
	{
		...
		description:
			'Contributed to developing the D3 Smart SOAR platform to automate incident response and improve cybersecurity workflows.',
		responsibilities: [
			'Fixed 50+ bugs across multiple project modules, significantly improving product stability and performance',
			'Developed and launched 2 major features, enhancing core functionality and user engagement',
			'Implemented inline editing in data tables, boosting user efficiency and improving the overall user experience',
			'Utilized my UI/UX design expertise to enhance visuals and improve the logic and usability of 2 key project pages',
			'Refactored codebase on both frontend and backend, improving performance and reducing client-side processing time by 20%, while ensuring more predictable and reliable functionality',
		],
		techStack: [
			'React',
			'JavaScript',
