	...
	return (
		...
		>
			<a
				...
				className='relative group after:duration-300 after:w-0 after:h-0 after:bg-global-color-two-scheme-1/15 after:absolute after:top-1/2 after:left-1/2 after:-translate-x-1/2 after:-translate-y-1/2 after:rounded-3xl hover:after:w-full hover:after:h-full'
			>
